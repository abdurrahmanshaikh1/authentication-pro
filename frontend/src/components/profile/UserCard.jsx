...
const UserCard = ({ user }) => (
  <>
    ...
    <div className="space-y-2 p-2">
      <div className="flex items-center gap-3 p-2.5 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 rounded-lg hover:bg-blue-50">
      ...
      <div className="flex items-center gap-3 p-2.5 bg-gradient-to-r from-emerald-50/80 to-green-50/80 rounded-lg hover:bg-emerald-50">
